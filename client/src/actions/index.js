...
export const fetchUser = () => async dispatch => {
        ...
        //fetch user data and dispatch it
...
export const registerUser = (user) => async dispatch => {
        //register new user and dispatch its data
...
export const fetchPropertiesSearched = (data) => async dispatch => {
        //fetch properties via seach options
...
export const fetchProperty = (propertyId) => async dispatch => {
        //fetch single property for detail
